...
class Generator3D_TSNE(object):
    ...
    def generate_mesh(self, data, return_stats=True):
        ...
        mesh, latent_map = self.generate_from_latent(z, c, stats_dict=stats_dict, **kwargs)

        if return_stats:
            return mesh, stats_dict
        else:
            return mesh, latent_map
    ...
    def eval_points(self, p, z, c=None, **kwargs):
        ...
        for pi in p_split:
            ...
            with torch.no_grad():
                ...
                logits = self.model.decoder(pi, z, c, **kwargs)
